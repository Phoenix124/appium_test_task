...
public class MainPage extends AbstractScreen {
    ...
    @AndroidFindBySet(@AndroidFindBy(id = APP_PACKAGE_ID + "/title"))
...
//    private  MobileElement contextActionMenu;
    ...
    @AndroidFindBySet(@AndroidFindBy(id = APP_PACKAGE_ID + "/complete"))
    ...
    public AddTaskWindow addNewToDoTask() {
        addNewTaskFabIcon.click();
        return new AddTaskWindow(driver);
    }
...
//        ((AndroidDriver) driver).pressKeyCode(AndroidKeyCode.KEYCODE_MENU);
    ...
    public void navigateToTaskDetail(){
        taskListItems.get(0).click();
    }
}
